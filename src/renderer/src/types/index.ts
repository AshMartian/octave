...
export interface SongMetadata {
  ...
  icon?: string
  /** Explicit consent gate for MIDI-only training dataset export. */
  dataset_opt_in?: string
  /** Written by Octave after STRUM generates a song; defaults to dataset opt-out. */
  strum_generated?: string
...
// Valid RB3 commands that OCTAVE does not yet expose as editable venue or
